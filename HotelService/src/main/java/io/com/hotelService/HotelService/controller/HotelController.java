...
import io.com.hotelService.HotelService.services.HotelService;
...
public class HotelController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Hotel> getHotelById(@PathVariable String id) throws ResourceNotFoundException{
